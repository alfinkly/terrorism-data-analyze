...
def run_analysis():
    ...
    central_asia_attacks = attacks_per_million.loc[
        attacks_per_million.index.isin(central_asia_countries)
    ]
    ...
    plt.xticks(rotation=45, ha="right")
    plt.tight_layout()
    plt.savefig("attachments/attacks_per_capita_central_asia.png")
    plt.show()
